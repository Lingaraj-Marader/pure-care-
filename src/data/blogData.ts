...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Ceramic coating has revolutionized car paint protection. Learn about the benefits, costs, and whether it's the right choice for your vehicle. We break down everything from 9H hardness ratings to hydrophobic properties.",
  ...
  },
  {
    ...
    excerpt:
      "Two of the most popular paint protection options compared head-to-head. Understand the differences, pros and cons, and find out which protection method suits your driving needs and budget best.",
  ...
  },
  {
    ...
    excerpt:
      "Invested in a vinyl wrap? Learn the essential maintenance tips to keep your wrap looking fresh and extend its lifespan. From washing techniques to storage recommendations.",
    category: "Wrapping",
  ...
  },
  {
    ...
    excerpt:
      "Graphene coating is the latest innovation in automotive protection. Learn how this Nobel Prize-winning material is being used to provide superior protection compared to traditional ceramic coatings.",
  ...
  },
  {
    ...
    excerpt:
      "Custom car floor mats are essential for protecting your vehicle's interior. We compare 3D and 5D floor mats to help you make the best choice for your car.",
    category: "Interior",
